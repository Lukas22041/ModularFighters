...
object ReflectionUtils {
    ...
    private val getTypeHandle = MethodHandles.lookup().findVirtual(fieldClass, "getType", MethodType.methodType(Class::class.java))
    ...
    fun setAtIndex(index: Int, instanceToModify: Any, newValue: Any?)
    {
        var field: Any? = null
        try {  field = instanceToModify.javaClass.fields[index] } catch (e: Throwable) {
            try {  field = instanceToModify.javaClass.declaredFields[index] } catch (e: Throwable) { }
        }
    ...
    fun setFieldOfType(type: Class<*>, instanceToModify: Any, newValue: Any?)
    {
        ...
        {
            setFieldAccessibleHandle.invoke(field, true)
            var fieldType: Class<*> = getTypeHandle.invoke(field) as Class<*>
            if (fieldType == type) {
                setFieldHandle.invoke(field, instanceToModify, newValue)
            }
    ...
    fun getAtIndex(index: Int, instanceToGetFrom: Any): Any? {
        var field: Any? = null
        try {  field = instanceToGetFrom.javaClass.fields[index] } catch (e: Throwable) {
            try {  field = instanceToGetFrom.javaClass.declaredFields[index] } catch (e: Throwable) { }
        }
    ...
    fun invokeByNameAlone(methodName: String, instance: Any, vararg arguments: Any?) : Any?
    {
        var method: Any? = null
