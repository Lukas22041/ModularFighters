...
class WeaponMountElement(var mount: WeaponSlotAPI, var weapon: WeaponSpecAPI?, var scale: Float, tooltip: TooltipMakerAPI, width: Float, height: Float) : LunaElement(tooltip, width, height) {
